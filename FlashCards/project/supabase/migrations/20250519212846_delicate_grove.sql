...
BEGIN
    ...
    DROP POLICY IF EXISTS "Users can manage their own groups" ON flashcard_groups;
    DROP POLICY IF EXISTS "Enable read access for users based on group ownership" ON flashcards;
    DROP POLICY IF EXISTS "Enable insert access for users based on group ownership" ON flashcards;
    DROP POLICY IF EXISTS "Enable update access for users based on group ownership" ON flashcards;
    DROP POLICY IF EXISTS "Enable delete access for users based on group ownership" ON flashcards;
